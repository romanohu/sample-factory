...
def add_model_args(p: ArgumentParser):
    ...
    p.add_argument(
        ...
        choices=["convnet_simple", "convnet_impala", "convnet_atari", "resnet_impala", "convnet_overcooked_v2"],
        type=str,
...
def add_pbt_args(p: ArgumentParser):
    ...
    p.add_argument(
        ...
        default=None,
        type=str,
        help="Name of the agent policy mapping to use. If not specified, the default mapping is used. "
        "See sample_factory.algo.utils.agent_policy_mapping for more details.",
    )
    p.add_argument(
    ...
    p.add_argument(
        ...
        default=None,
        type=str,
        help="Names of the auxiliary models to use. "
        "Multiple names can be separated by commas. "
        "If not specified, no auxiliary models are used. "
        "See sample_factory.aux_models.aux_model for more details.",
    )
